...
class AttentionModule_stage0(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(112, 112), size2=(56, 56), size3=(28, 28), size4=(14, 14), retrieve_mask=False):
        super().__init__()
        self.first_residual_blocks = ResidualBlock(in_channels, out_channels)
        self.trunk_branches = nn.Sequential(
            ResidualBlock(in_channels, out_channels),
...
class AttentionModule_stage1(nn.Module):
    # input size is 56x56
    def __init__(self, in_channels, out_channels, size1=(56, 56), size2=(28, 28), size3=(14, 14), retrieve_mask=False):
        super().__init__()
        self.first_residual_blocks = ResidualBlock(in_channels, out_channels)

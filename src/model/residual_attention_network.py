...
class ResidualAttentionModel_56(nn.Module):
    ...
    def __init__(self, retrieve_layers=False, retrieve_masks=False):
        ...
        self.attention_module1 = AttentionModule_stage1(256, 256, retrieve_mask=self.retrieve_masks)
        self.residual_block2 = ResidualBlock(256, 512, 2)
        self.attention_module2 = AttentionModule_stage2(512, 512, retrieve_mask=self.retrieve_masks)
        self.residual_block3 = ResidualBlock(512, 1024, 2)
        self.attention_module3 = AttentionModule_stage3(1024, 1024, retrieve_mask=self.retrieve_masks)
    ...
    def forward(self, x):
        ...
        if self.retrieve_layers and not self.retrieve_masks:
            layers = (conv1_out, mpool1_out, res1_out, atten1_out, res2_out, atten2_out, res3_out, atten3_out, res4_out, res5_out, res6_out, mpool2_out)
            return out, layers
